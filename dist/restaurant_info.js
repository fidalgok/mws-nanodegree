...
window.initMap = () => {
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) {
      ...
      fillBreadcrumb();
      _dbhelper__WEBPACK_IMPORTED_MODULE_0__["default"].mapMarkerForRestaurant(self.restaurant, self.map);
    }
  });
};
...
function fetchRestaurantFromURL(callback) {
  ...
  if (!id) {
    ...
    _dbhelper__WEBPACK_IMPORTED_MODULE_0__["default"].fetchRestaurantById(id, (error, restaurant) => {
